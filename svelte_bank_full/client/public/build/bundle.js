...
var app = (function () {
    ...
    const file$2 = "src/LoginForm.svelte";
    ...
    */
    ...
    const file$1 = "src/Authentication.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 33, 4, 835);
    			attr_dev(p, "class", "error-message svelte-1pasy9z");
    			add_location(p, file$1, 34, 4, 863);
    			...
    			add_location(input, file$1, 35, 4, 911);
    			attr_dev(button, "class", "svelte-1pasy9z");
    			add_location(button, file$1, 45, 4, 1124);
    			attr_dev(div, "class", "auth-form svelte-1pasy9z");
    			add_location(div, file$1, 32, 0, 807);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Authentication> was created with unknown prop '${key}'`);
    	});
    ...
    const file = "src/MainPage.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 189, 4, 5297);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = getCurrencySymbol(/*currencies*/ ctx[0][/*currentCurrencyIndex*/ ctx[1]].currency) + "";
    	let t2;
    	let t3;
    	let button0;
    	let t5;
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*existing_currencies*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			h3 = element("h3");
    			h3.textContent = "Transaction history:";
    			t7 = space();
    			div1 = element("div");
    			input = element("input");
    			t8 = space();
    			...
    			attr_dev(h2, "class", "svelte-ks4ywx");
    			add_location(h2, file, 130, 6, 3531);
    			attr_dev(button0, "class", "change-currency svelte-ks4ywx");
    			add_location(button0, file, 134, 6, 3676);
    			attr_dev(div0, "class", "balance-and-change-currency svelte-ks4ywx");
    			add_location(div0, file, 129, 4, 3483);
    			add_location(h3, file, 140, 8, 3867);
    			input.required = "";
    			attr_dev(input, "placeholder", "Amount");
    			attr_dev(input, "inputmode", "numeric");
    			attr_dev(input, "maxlength", "10");
    			attr_dev(input, "pattern", "^[-]?[0-9]+[\\.]?[0-9]*$");
    			attr_dev(input, "class", "svelte-ks4ywx");
    			add_location(input, file, 142, 10, 3945);
    			attr_dev(select, "class", "svelte-ks4ywx");
    			if (/*currency*/ ctx[5] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[10].call(select));
    			add_location(select, file, 150, 10, 4169);
    			attr_dev(button1, "class", "invite-btn svelte-ks4ywx");
    			attr_dev(button1, "type", "button");
    			add_location(button1, file, 157, 10, 4420);
    			attr_dev(div1, "class", "input-container svelte-ks4ywx");
    			add_location(div1, file, 141, 8, 3905);
    			attr_dev(div2, "class", "title-and-input svelte-ks4ywx");
    			add_location(div2, file, 139, 6, 3829);
    			attr_dev(th0, "class", "svelte-ks4ywx");
    			add_location(th0, file, 169, 12, 4693);
    			attr_dev(th1, "class", "svelte-ks4ywx");
    			add_location(th1, file, 170, 12, 4719);
    			attr_dev(th2, "class", "svelte-ks4ywx");
    			add_location(th2, file, 171, 12, 4745);
    			attr_dev(tr, "class", "svelte-ks4ywx");
    			add_location(tr, file, 168, 10, 4676);
    			attr_dev(thead, "class", "svelte-ks4ywx");
    			add_location(thead, file, 167, 8, 4658);
    			add_location(tbody, file, 174, 8, 4802);
    			attr_dev(table, "class", "history svelte-ks4ywx");
    			add_location(table, file, 166, 6, 4626);
    			attr_dev(div3, "class", "operations svelte-ks4ywx");
    			add_location(div3, file, 138, 4, 3798);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*amount*/ ctx[4]);
    			append_dev(div1, t8);
    			...
    			select_option(select, /*currency*/ ctx[5], true);
    			append_dev(div1, t9);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t2_value !== (t2_value = getCurrencySymbol(/*currencies*/ ctx[0][/*currentCurrencyIndex*/ ctx[1]].currency) + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*amount*/ 16 && input.value !== /*amount*/ ctx[4]) {
    				set_input_value(input, /*amount*/ ctx[4]);
    			}

    			if (dirty & /*existing_currencies, getCurrencySymbol*/ 4) {
    				each_value_1 = /*existing_currencies*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*currency, existing_currencies*/ 36) {
    				select_option(select, /*currency*/ ctx[5]);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(129:2) {#if currencies.length > 0}",
    		ctx
    	});
    ...
    // (152:12) {#each existing_currencies as cur}
    function create_each_block_1(ctx) {
    	let option;
    	let t0_value = /*cur*/ ctx[17].code + "";
    	let t0;
    	let t1;
    	let t2_value = getCurrencySymbol(/*cur*/ ctx[17].code) + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text(")\n              ");
    			option.__value = option_value_value = /*cur*/ ctx[17].code;
    			option.value = option.__value;
    			add_location(option, file, 152, 14, 4261);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*existing_currencies*/ 4 && t0_value !== (t0_value = /*cur*/ ctx[17].code + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*existing_currencies*/ 4 && t2_value !== (t2_value = getCurrencySymbol(/*cur*/ ctx[17].code) + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*existing_currencies*/ 4 && option_value_value !== (option_value_value = /*cur*/ ctx[17].code)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(152:12) {#each existing_currencies as cur}",
    		ctx
    	});
    ...
    // (176:10) {#each currencies[currentCurrencyIndex].transactions as transaction}
    function create_each_block$1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = formatDate(/*transaction*/ ctx[14].dateTime).date + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = formatDate(/*transaction*/ ctx[14].dateTime).time + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*transaction*/ ctx[14].amount + "";
    	let t4;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			attr_dev(td0, "class", "svelte-ks4ywx");
    			add_location(td0, file, 177, 14, 4920);
    			attr_dev(td1, "class", "svelte-ks4ywx");
    			add_location(td1, file, 178, 14, 4983);
    			attr_dev(td2, "class", "svelte-ks4ywx");
    			toggle_class(td2, "positive", /*transaction*/ ctx[14].amount >= 0);
    			toggle_class(td2, "negative", /*transaction*/ ctx[14].amount < 0);
    			add_location(td2, file, 179, 14, 5046);
    			attr_dev(tr, "class", "svelte-ks4ywx");
    			add_location(tr, file, 176, 12, 4901);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t0_value !== (t0_value = formatDate(/*transaction*/ ctx[14].dateTime).date + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t2_value !== (t2_value = formatDate(/*transaction*/ ctx[14].dateTime).time + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t4_value !== (t4_value = /*transaction*/ ctx[14].amount + "")) set_data_dev(t4, t4_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(176:10) {#each currencies[currentCurrencyIndex].transactions as transaction}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*currencies*/ ctx[0].length > 0) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			if_block.c();
    			add_location(h1, file, 125, 4, 3361);
    			attr_dev(p, "class", "error-message svelte-ks4ywx");
    			add_location(p, file, 126, 4, 3396);
    			attr_dev(div0, "class", "header-container svelte-ks4ywx");
    			add_location(div0, file, 124, 2, 3326);
    			attr_dev(div1, "class", "main-page svelte-ks4ywx");
    			add_location(div1, file, 123, 0, 3300);
    		},
    		l: function claim(nodes) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	async function getStory() {
    		...
    		try {
    			...
    			$$invalidate(3, errorMessage = "Error fetching user data");
    		}
    		...
    		try {
    			...
    			const data = await response.json();
    			$$invalidate(2, existing_currencies = data.currencies);
    		} catch(error) {
    			console.error("Error fetching currencies:", error);
    			$$invalidate(3, errorMessage = "Error fetching currencies");
    		}
    	}
    		...
    		if (amount && currency) {
    			...
    			try {
    				...
    				if (data.result) {
    					...
    					$$invalidate(3, errorMessage = "Transaction was not successful");
    				}
    			} catch(error) {
    	...
    	function select_change_handler() {
    		...
    		$$invalidate(5, currency);
    		$$invalidate(2, existing_currencies);
    	}

    	const click_handler_1 = () => makePayment(amount, currency);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('existing_currencies' in $$props) $$invalidate(2, existing_currencies = $$props.existing_currencies);
