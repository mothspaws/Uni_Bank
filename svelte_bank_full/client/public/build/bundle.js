    ...
    */
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(54:2) {#if currencies.length > 0}",
    		ctx
    	});
    ...
    // (80:10) {#each currencies[currentCurrencyIndex].transactions as transaction}
    function create_each_block$1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*transaction*/ ctx[8].dateTime.slice(0, 11) + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*transaction*/ ctx[8].dateTime.slice(12, 20) + "";
    	let t2;
    	let t3;
    	let td2;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t0_value !== (t0_value = /*transaction*/ ctx[8].dateTime.slice(0, 11) + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*currencies, currentCurrencyIndex*/ 3 && t2_value !== (t2_value = /*transaction*/ ctx[8].dateTime.slice(12, 20) + "")) set_data_dev(t2, t2_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(80:10) {#each currencies[currentCurrencyIndex].transactions as transaction}",
    		ctx
    	});
